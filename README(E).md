...
The main project license is [GNU LGPLv3](LICENSE). Third-party components in this repository may use their own licenses; refer to the corresponding license files for their terms.
